  ...
  return (
    <>
      {response.length == 0 ? (
        ...
        <>
          <article className={`page-center-parent-container absolute top-0 animate-slide-in ${modalVisible ? 'top-0  z-10  overflow-scroll max-h-screen h-full block' : ' hidden -z-[1] top-[100%] overflow-hidden max-h-0 '} `}>
            <main className="relative small-border-left small-border-right custom-border-grey800 background-custom-white scroll-smooth">
              {/* Back Button */}
