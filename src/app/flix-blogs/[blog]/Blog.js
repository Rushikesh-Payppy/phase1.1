  ...
  return (
    <>
      {response.length == 0 ? (
        ...
        <>
            <article className="page-center-parent-container">
              <main className="small-border-left small-border-right custom-border-grey800 background-custom-white scroll-smooth">
                {/* Back Button */}
