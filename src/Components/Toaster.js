  ...
  return (
    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:border-[0.5px] border-blue-700 border-[#FFFFFF4D] group-[.toaster]:bg-[#1A1917CC] group-[.toaster]:text-foreground group-[.toaster]: group-[.toaster]:shadow-lg group-[.toaster]:flex justify-center items-center py-4 ",
          actionButton:
